...
class AffiliatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create affiliate" do
    assert_difference("Affiliate.count") do
      post affiliates_url, params: { affiliate: { accepted_at: @affiliate.accepted_at, accepted_image_use: @affiliate.accepted_image_use, cep: @affiliate.cep, city: @affiliate.city, complement: @affiliate.complement, cpf: @affiliate.cpf, email: @affiliate.email, name: @affiliate.name, neighborhood: @affiliate.neighborhood, number: @affiliate.number, signature_name: @affiliate.signature_name, state: @affiliate.state, street: @affiliate.street, whatsapp: @affiliate.whatsapp } }
    end
  ...
  test "should update affiliate" do
    patch affiliate_url(@affiliate), params: { affiliate: { accepted_at: @affiliate.accepted_at, accepted_image_use: @affiliate.accepted_image_use, cep: @affiliate.cep, city: @affiliate.city, complement: @affiliate.complement, cpf: @affiliate.cpf, email: @affiliate.email, name: @affiliate.name, neighborhood: @affiliate.neighborhood, number: @affiliate.number, signature_name: @affiliate.signature_name, state: @affiliate.state, street: @affiliate.street, whatsapp: @affiliate.whatsapp } }
